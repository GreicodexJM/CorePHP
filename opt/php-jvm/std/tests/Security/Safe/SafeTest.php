...
namespace std\Tests\Security\Safe;
...
final class SafeTest extends TestCase
{
    ...
    {
        $result = Safe::jsonDecode('{"name":"Alice","age":30}');
    ...
    public function testFileWriteThrowsOnUnwritablePath(): void
    {
        ...
        Safe::fileWrite('/root/cannot_write_here_' . uniqid() . '.txt', 'data');
    }
}
