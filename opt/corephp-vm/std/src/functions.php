 ...
 *
 * They are thin wrappers around the core\Security\Safe and core\IO classes.
...
if (!function_exists('s_json')) {
     ...
     *
     * @throws \core\Security\Safe\JsonDecodeException on invalid JSON
     */
...
if (!function_exists('s_enc')) {
     ...
     *
     * @throws \core\Security\Safe\JsonEncodeException if encoding fails
     */
...
if (!function_exists('s_int')) {
     ...
     * @return int
     *
     * @throws \core\Security\Safe\TypeCoercionException for non-numeric values
     */
...
if (!function_exists('s_file')) {
     ...
     *
     * @throws \core\Security\Safe\FileReadException if file missing or unreadable
     */
...
if (!function_exists('s_write')) {
     ...
     *
     * @throws \core\Security\Safe\FileWriteException if write fails
     */
...
// =============================================================================
// Compatibility bridge — convert between plain PHP arrays and core collections
// =============================================================================
